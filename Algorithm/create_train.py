...
parser.add_argument('--nyu', type=str, help='path to nyu_depth_v2_labeled.mat',default="E:\Python Practice\AodNet\AODnet-by-pytorch-master")
parser.add_argument('--dataset', type=str, help='path to  synthesized hazy images dataset store',default="E:\Python Practice\AodNet\AODnet-by-pytorch-master\data")
